// Lightbulb Marker - Version 006
// Chunky 3D voxel model; the reference's white sticker outline is not geometry.
// Changes from previous version:
// - Widened/lowered the orange creature body for a closer front silhouette.
// - Enlarged the left protruding block and cleaned up the right-side step.
// - Moved the black square eyes higher and closer to the reference placement.
// - Shortened the bulb support so the light sits closer to the body.
...
body_core = [
    [-40, 18, 88, 48],   // broader main body mass
    [-64, 30, 24, 20],   // larger left block protrusion
...
// A short centered support keeps the bulb printable without becoming a chimney.
rear_post = [-6, 84, 12, 0, post_depth, 12];
