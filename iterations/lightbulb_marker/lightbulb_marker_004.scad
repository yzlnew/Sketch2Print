// Lightbulb Marker - Version 004
// True 3D voxel-style interpretation of the reference.
// Changes from previous version:
// - Kept the white sticker outline out of the printable model.
// - Added an orange structural neck so the bulb is physically connected.
// - Removed fake front-facing side-color blocks that read like flat artwork.
// - Preserved chunky 3D body depth with shallow raised face and bulb details.
